            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex gap-3">
                  <Link href="/claim/demo" className="btn-soft">Abrir demo</Link>
                  <Link href="/explore" className="btn-soft">Ver campañas</Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl p-8 text-center shadow-2xl">
            ...
            <div className="mt-5 flex items-center justify-center gap-3">
              <Link href="/organize" className="btn-soft">Únete como Organizador</Link>
